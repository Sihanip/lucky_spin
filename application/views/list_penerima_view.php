        ...
        <form  role="form" id="simpan_cust" action="<?php echo base_url() ?>add_customer/simpan_customer" method="post" >
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="voucher_generated" name="voucher_generated" >
                    <fieldset disabled>
                        <input type="text" class="form-control" id="voucher_generated2" name="voucher_generated2" >
                    </fieldset>
                </div>
            </div>
    ...
    $('#select_toko').change(function(){
            ...
            {  targets: 5,
                ...
                render: function (data, type, row, meta) {
                    return '<input type="button" class="simpan_customer" id=s-"' + meta.row + '" value="Tambah Stok"/>';
                }
